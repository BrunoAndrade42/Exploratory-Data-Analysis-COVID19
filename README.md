...
# Mais um pouco de análises com os dados confirmados em todo o mundo, mas com os dados de 2022 também
...
```
    ...
    ## Warning: Removed 3718 row(s) containing missing values (geom_path).
